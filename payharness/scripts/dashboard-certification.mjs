...
const requiredPages = [
  ['Developer Portal', path.join(pagesRoot, 'developers', 'index.tsx'), ['Developer Portal', '/developers/api-keys', '/developers/webhooks', '/developers/usage', '/developers/docs', 'Quickstart', 'Official SDKs']],
